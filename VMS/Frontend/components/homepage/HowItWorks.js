                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                    ...
                    {steps.map((item, index) => (
                        <div key={index} className="relative z-10 bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group border border-gray-100">
                            <div className="w-16 h-16 bg-primary-500 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 group-hover:bg-primary-600 transition-colors shadow-md border-4 border-white">
                                {item.step}
                            </div>
