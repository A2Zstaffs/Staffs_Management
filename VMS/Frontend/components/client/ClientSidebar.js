...
export default function ClientSidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-[#0F172A] to-[#1e293b] text-white z-40">
      <div className="flex flex-col h-full">
        ...
        <div className="px-6 py-5 border-b border-gray-700/50">
          <div className="flex flex-col">
            ...
            <p className="text-xs text-gray-300 font-medium mt-2">{clientName || 'Client'}</p>
          </div>
        </div>
