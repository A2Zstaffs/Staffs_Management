      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-gradient-to-br from-primary-50 to-primary-100 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/20 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/30 p-8">
            {/* Signup Heading */}
            <h1 className="text-3xl font-bold text-secondary-800 mb-8">Sign Up</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 placeholder-gray-500 focus:bg-white/90 ${errors.fullName ? 'border-red-500' : 'border-white/50'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 placeholder-gray-500 focus:bg-white/90 ${errors.email ? 'border-red-500' : 'border-white/50'
                      }`}
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
                    required
                  />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 placeholder-gray-500 pr-10 focus:bg-white/90 ${errors.password ? 'border-red-500' : 'border-white/50'
                        }`}
                      style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
                      required
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 placeholder-gray-500 pr-10 focus:bg-white/90 ${errors.confirmPassword ? 'border-red-500' : 'border-white/50'
                        }`}
                      style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
                      required
                    />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 focus:bg-white/90 ${errors.dateOfBirth ? 'border-red-500' : 'border-white/50'
                      }`}
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
                    required
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className={`w-full px-4 py-3 bg-white/80 backdrop-blur-sm border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-secondary-900 focus:bg-white/90 ${errors.role ? 'border-red-500' : 'border-white/50'
                      }`}
                    style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}
                    required
                  >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="A2Z Staffs Platform - Homepage"
            fill
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center p-8 w-full h-full">
          ...
          <div className="max-w-md mt-20">
            ...
            <h2 className="text-3xl font-bold text-white/90 mb-6 drop-shadow-lg">A2Z Staffs platform</h2>
