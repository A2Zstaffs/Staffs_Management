...
export default function ServicesPage() {
    const services = [
        {
            ...
            icon: (
                <svg className="w-12 h-12 text-primary-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <div className="bg-secondary-50 min-h-screen">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-primary-500 to-primary-700 py-20">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="bg-white rounded-2xl border border-secondary-100 shadow-sm p-8 hover:shadow-lg hover:border-primary-200 hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="bg-white py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-secondary-900 mb-8">Ready to get started?</h2>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/contact" className="inline-flex items-center justify-center px-8 py-3.5 bg-primary-500 text-white rounded-xl font-semibold hover:bg-primary-600 transition-all duration-200 shadow-lg hover:scale-[1.02] active:scale-95">
                            Talk to Our Team
                        </Link>
                        <Link href="/candidate/explore-jobs" className="inline-flex items-center justify-center px-8 py-3.5 bg-white border-2 border-primary-500 text-primary-600 rounded-xl font-semibold hover:bg-primary-50 transition-colors">
                            Browse Jobs
                        </Link>
                    </div>
                </div>
